    ...
    void Strike()
    {
       Collider[] hitEnemies = Physics.OverlapSphere(attackPoint.position, attackRange, damageLayers);
        foreach(Collider enemy in hitEnemies)
        {
            ...
            EnemyShooter3 enemyShooter = hit.transform.gameObject.GetComponent<EnemyShooter3>();
            EnemyController3 enemyController = hit.transform.gameObject.GetComponent<EnemyController3>();
