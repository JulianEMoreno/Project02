    ...
    void Strike()
    {
       Collider[] hitEnemies = Physics.OverlapSphere(attackPoint.position, attackRange, damageLayers);
        foreach(Collider enemy in hitEnemies)
        {
            ...
            EnemyShooter2 enemyShooter = hit.transform.gameObject.GetComponent<EnemyShooter2>();
            EnemyController2 enemyController = hit.transform.gameObject.GetComponent<EnemyController2>();
